...
| `replay capsule --artifacts <artifact-root> [--write-readme] [--write-json]` | Return the replay front door with session counts, primary failure, artifact counts, recommended next steps, and suggested commands |
