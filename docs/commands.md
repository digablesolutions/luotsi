...
- `run-summary.json` uses the `luotsi-run-summary.v1` contract documented in `docs/schemas/luotsi-run-summary-v1.md`; use `replay packet --check` as the CI/agent gate for an existing packet.
