...
| `replay capsule --artifacts <artifact-root> [--write-readme]` | Return a compact capsule manifest with session counts, primary failure, artifact counts, and suggested next commands |
