...
| `artifacts verify <artifact.zip> [--output <directory>]` | Validate a packed artifact bundle without writing files; reports manifest metadata, package SHA-256, lab-safe redaction status, entry count, the suggested unpack directory, and exact unpack/replay commands |
