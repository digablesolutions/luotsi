...
Quickstart envelopes additionally include `data.proof_checks[]`. Those checks are readiness evidence gates for the first-five-minute path, not a replacement for the next-command priority order above.
