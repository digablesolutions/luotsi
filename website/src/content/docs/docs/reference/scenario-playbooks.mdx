...
When the starting point is an Android CLI Journey-style objective (not an Android Intent object),
capture that objective first with the repository's journey intake template, then promote reviewed
