...
```bash
luotsi artifacts info --artifacts artifacts/first-run
luotsi artifacts open --artifacts artifacts/first-run --dry-run
```

For CI or shared-lab review, package and verify the artifact root:

```bash
luotsi artifacts pack --artifacts artifacts/first-run --output artifacts/first-run.zip
luotsi artifacts verify --bundle artifacts/first-run.zip
```
