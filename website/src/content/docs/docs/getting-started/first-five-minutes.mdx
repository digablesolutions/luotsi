...
`replay packet` writes the production handoff files first. Use `replay open --dry-run` when a human also wants the browser-free replay front door without launching the local artifact browser.
