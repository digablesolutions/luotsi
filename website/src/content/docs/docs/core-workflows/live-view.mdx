...
- `artifacts open` and `replay open` both work against that same root after the session ends, depending on whether you want the generic artifact browser or the replay-specific front door
