...
<figure class="architecture-diagram">
	...
	<figcaption>The live view path separates video transport, host-routed input, JSONL session events, artifact capture, and read-only observer joins so replay can start from saved evidence later.</figcaption>
</figure>
