...
luotsi artifacts intake my-run-lab-safe.zip --output ./artifacts/my-run --require-lab-safe --sha256 <digest>
...
- `artifacts intake`: validate, restore, refresh the index, and return info/open/replay commands for a received package in one step
