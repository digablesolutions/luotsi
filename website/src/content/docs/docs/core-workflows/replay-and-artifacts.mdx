...
- `run-summary.json` and `run-summary.md` are the stable packet files to attach to CI, reviews, and agent loops after `replay packet`, with the source contract documented in `docs/schemas/luotsi-run-summary-v1.md`
