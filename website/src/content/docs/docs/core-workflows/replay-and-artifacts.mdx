...
- `replay capsule`: compact manifest with primary failure, failure timeline with exact reopen commands, existing scenario draft artifacts, artifact manifest, and suggested next commands
