...
6. Command arrays such as `data.commands`, `data.artifact_commands`, and `data.recommended_commands`
7. `artifacts.artifact_root` as the fallback evidence pointer, then run `luotsi replay packet --artifacts <artifact-root>`
