...
When the captured command results and replay metadata include a trusted app package and adb target, the generated draft records package/device provenance and the validated handoff commands use those values for preflight and execution.
