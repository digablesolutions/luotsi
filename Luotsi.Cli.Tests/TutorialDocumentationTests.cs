...
public sealed partial class AppTests
{
    ...
    public void Run_Summary_Schema_Guide_Documents_Production_Packet_Contract()
    {
        ...
        Assert.Contains("packet identity values for artifact root, status, verdict, session count, and failure count", schemaGuide, StringComparison.Ordinal);
        ...
        Assert.Contains("Markdown without packet identity values for artifact root, status, verdict, session count, or failure count", schemaGuide, StringComparison.Ordinal);
