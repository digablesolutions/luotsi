...
- `Luotsi.Cli\Telemetry\` parses kiosk semantic telemetry from logcat (`LUOTSI_DEVICE_TELEMETRY`) and feeds both direct telemetry commands and semantic waits such as `wait-step` / `wait-action-ready`.
