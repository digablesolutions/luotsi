...
internal static class AndroidRuntimeDefaults
{
    ...
    public const string ViewHelperPathEnvironmentVariable = "DEVICE_E2E_VIEW_HELPER_APK";
    public const string LegacyViewHelperPathEnvironmentVariable = "DEVICE_E2E_VIEW_HELPER_JAR";
