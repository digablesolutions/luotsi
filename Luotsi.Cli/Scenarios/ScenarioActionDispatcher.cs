    ...
    IDelay delay)
{
    ...
    public async Task<object> ExecuteAsync(ScenarioStep step, DateTimeOffset? previousStepStartedAt)
    {
        return step.Action switch
        {
            ...
            "assertScreenshot" => await _screenshotAssertionHost.AssertScreenshotAsync(step.Label ?? step.Text ?? step.Name ?? "screenshot", step.ExpectedWidth, step.ExpectedHeight, step.ExpectedSha256, step.ExpectedSha256File, step.BaselineFile, step.UpdateBaseline is true).ConfigureAwait(false),
