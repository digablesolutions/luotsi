...
internal static class ReplayGraphTaxonomy
{
    public static ReplayGraphTaxonomyResult Build(string artifactRoot) => new(
        ...
        [
            ...
            new("draft_source", "Source family for generated steps and draft normalizations, such as inspect command or telemetry."),
            new("draft_normalization", "Stabilization or cleanup normalization applied while generating a draft.")
        ],
        EdgeKinds:
        [
            ...
            new("derived_from", "Generated step or draft normalization came from a source event family."),
