...
The Luotsi CLI validation command checks the same production handoff before it
is turned into scenario work, and returns a non-zero exit code when required
guardrails or commands are missing.
